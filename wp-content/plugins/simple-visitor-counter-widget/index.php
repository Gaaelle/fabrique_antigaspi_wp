...
class SimpleVisitorCounter_Widget extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        <aside class="widget" id="visitor-counter">
          <!-- Inline style deleted ( style="font-family:<?php# echo $headingfontfamily ?>; color:<?php# echo $headingcolor ?>;"  ) -->
            <h2 class="visitor-counter-heading">Nombre de visiteurs:</h2>
            <!-- Inline style deleted ( style="color: <?php# echo $textcolor ?>; font-family: <?php# echo $textfontfamily ?>;"  ) -->
        <div class="visitor-counter-content">
            <ul class="counter-list">
                <li class="counter">Aujourd'hui: <?php echo vcp_get_visit_count('D') ?></li>
                <li class="counter">Hier: <?php echo vcp_get_visit_count('Y') ?></li>
                <li class="counter">Cette semaine: <?php echo vcp_get_visit_count('W') ?></li>
            </ul>
            <ul class="counter-list">
                <li class="counter">Ce mois ci: <?php echo vcp_get_visit_count('M') ?></li>
                <li class="counter">Au total: <?php echo vcp_get_visit_count('T') ?></li>
                <li class="counter">Visiteur actif: <?php echo vcp_get_visit_count('C') ?></li>
            </ul>
        </div>
        </aside>
